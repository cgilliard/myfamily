...
struct Reader {
    int (*read_fixed_bytes)(struct Reader* reader, unsigned char* buffer,
        u64 len);
    void* ptr;
};
...
struct Writer {
    int (*write_fixed_bytes)(struct Writer* writer, unsigned char* buffer,
        u64 len);
    void* ptr;
};
