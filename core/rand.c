...
int rand_i32(i32 *v) {
	...
	*v = ((i32)buf[0] << 24) + ((i32)buf[1] << 16) + ((i32)buf[2] << 8) +
	     (i32)buf[3];
	return ret;
}
...
int rand_u32(u32 *v) {
	char buf[4];
	int ret = getentropy(buf, 4);
	*v = ((u32)buf[0] << 24) + ((u32)buf[1] << 16) + ((u32)buf[2] << 8) +
	     (u32)buf[3];
	return ret;
}
...
int rand_i64(i64 *v) {
	...
	*v = ((i64)buf[0] << 56) + ((i64)buf[1] << 48) + ((i64)buf[2] << 40) +
	     ((i64)buf[3] << 32) + ((i64)buf[4] << 24) + ((i64)buf[5] << 16) +
	     ((i64)buf[6] << 8) + (i64)buf[7];
	return ret;
}
...
int rand_u64(u64 *v) {
	char buf[8];
	int ret = getentropy(buf, 8);
	*v = ((u64)buf[0] << 56) + ((u64)buf[1] << 48) + ((u64)buf[2] << 40) +
...
int rand_i128(i128 *v) {
	...
	*v = ((i128)buf[0] << 120) + ((i128)buf[1] << 112) +
...
int rand_u128(u128 *v) {
	char buf[16];
	int ret = getentropy(buf, 16);
	*v = ((u128)buf[0] << 120) + ((u128)buf[1] << 112) +
