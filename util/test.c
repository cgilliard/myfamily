...
Test(util, slabio) {
	...
	String s_in, s_out;
	string_set(&s_in,
		   "01234567890123456789012345678901234567890123456789001234567"
		   "8901234567890123");
...
Test(util, over_read) {
	...
	String s_in, s_out;
	string_set(&s_in,
		   "01234567890123456789012345678901234501234567890123456789012"
...
Test(util, option) {
	...
	char *ptr1 = opt3.is_some() ? ((String*)Unwrap(opt3))->ptr : "my default
	str"; cr_assert_eq(strcmp(ptr1, "this is a test"), 0); Option opt4 =
	None; char *ptr2 = opt4.is_some() ? ((String*)Unwrap(opt4))->ptr : "my
	default str"; cr_assert_eq(strcmp(ptr2, "my default str"), 0);
	*/
}
